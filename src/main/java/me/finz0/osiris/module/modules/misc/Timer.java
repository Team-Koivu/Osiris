...
public class Timer extends Module {
    ...
    public void setup(){
        OsirisMod.getInstance().settingsManager.rSetting(tpsSync = new Setting("TpsSync", this, true, "TimerTpsSync"));
        OsirisMod.getInstance().settingsManager.rSetting(multiplier = new Setting("Multiplier", this, 5.0, 0.1, 20.0, false, "TimerMultiplier"));
    }
