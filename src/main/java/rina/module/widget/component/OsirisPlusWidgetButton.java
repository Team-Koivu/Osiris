 ...
 *
 **/
public class OsirisPlusWidgetButton extends OsirisPlusWidgetAbstract {
	...
	public OsirisPlusWidgetButton(OsirisPlusWidgetContainer container, Setting setting, int next_y) {
