 ...
 *
 **/
public class OsirisPlusWidgetCombo extends OsirisPlusWidgetAbstract {
	...
	public OsirisPlusWidgetCombo(OsirisPlusWidgetContainer container, Setting setting, int next_y) {
	...
	public void render() {
		...
		if (this.render_button) {
			if (isMousePassing()) {
				...
				TurokString.renderString("> " + this.setting.getValString(), this.rect.x + 2, this.rect.y + this.height_offset, this.button_name_r, this.button_name_g, this.button_name_b, this.shadow, this.smooth);
			} else {
